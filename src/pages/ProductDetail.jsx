...
const ProductDetail = () => {
  ...
  return (
    <ProductDetailStyled>
      ...
      {product && (
        <>
        <img src={product.thumbnail} width='390' height={420}></img>
      ...
      <GrayLine/>
        <div style={{width:'100%',height:50,padding:10,marginBottom:10}}>
          <div style={{fontFamily: 'Noto Sans CJK KR',fontSize: 16,fontWeight: 700,lineHeight: 3,textAlign: 'left'}}>{product&& product.name}</div>
